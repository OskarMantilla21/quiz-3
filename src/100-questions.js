...
temperature /= 5;
console.log("[Question #24]: ", temperature); // should print 16
...
let number = 10;
console.log("[Question #31]: ", number); // should print true
...
if (booleanVar) {
  console.log("booleanVar is truthy");
} else {
